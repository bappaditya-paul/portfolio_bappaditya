 ...
 */
function __OriginkitBase_UserCursor(props: Partial<Props>) {
    props = { ...COMPONENT_DEFAULTS, ...props }
    const {
        name = COMPONENT_DEFAULTS.name,
        arrow,
        label,
        color = COMPONENT_DEFAULTS.color,
        textColor = COMPONENT_DEFAULTS.textColor,
        size = COMPONENT_DEFAULTS.size,
        labelTiltStrength = COMPONENT_DEFAULTS.labelTiltStrength,
        showLabel = COMPONENT_DEFAULTS.showLabel,
        // Flat offsets (Framer-friendly).
        offsetX = COMPONENT_DEFAULTS.offsetX,
        offsetY = COMPONENT_DEFAULTS.offsetY,
        labelOffsetX = COMPONENT_DEFAULTS.labelOffsetX,
        labelOffsetY = COMPONENT_DEFAULTS.labelOffsetY,
        labelOffsetUseDefault = COMPONENT_DEFAULTS.labelOffsetUseDefault,
        pressScale = COMPONENT_DEFAULTS.pressScale,
        classNames,
    ...
    const fullScreen = fullScreenProp ?? true
    ...
    // --- global cursor style when fullScreen --------------------------------
    useEffect(() => {
        if (!fullScreen || !hideNativeCursor || isTouchDevice) return
        document.body.classList.add("custom-cursor-active")
        return () => {
            document.body.classList.remove("custom-cursor-active")
        }
    }, [fullScreen, hideNativeCursor, isTouchDevice])
